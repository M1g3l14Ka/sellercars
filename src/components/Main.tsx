...
/**
 * Main Component - Displays car inventory and company information
 */
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-4xl font-bold text-orange-500 mb-2">
                {Math.round(
                  cars.reduce((sum, c) => sum + c.price, 0) / cars.length / 1000000
                )}
                M ₩
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {cars.map((car) => (
              <div
                key={car.id}
                className="group bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800 hover:border-orange-500/50 transition-all duration-300 hover:scale-[1.02] flex flex-col h-full"
              >
                {/* Image */}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-zinc-400 mb-8">
                We source premium vehicles directly from ENCAR, South Korea&apos;s
                largest and most trusted used car marketplace. Every vehicle is
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">
                      All vehicles from certified dealers on ENCAR platform
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">
                      No hidden fees, direct pricing from Korean marketplace
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">
                      Worldwide delivery with full documentation support
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section id="contact" className="py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-zinc-400 mb-10">
            Get in touch with us to learn more about any vehicle or start the
            import process.
          </p>
          <a
            href="/contacts"
